package com.example.common.fastDFS.myFastdfsClient;

import com.example.common.fastDFS.client.ErrorCode;
import com.example.common.fastDFS.client.FastDFSClient;
import com.example.common.fastDFS.client.FastDFSException;
import com.example.common.fastDFS.client.TrackerServerPool;
...
/**
 * description: 重写FastDFSClient的upload方法，当为外网环境时需要传入fastdfs的storage服务的外网IP和端口
 *
 * @author:cxs
 * @date: 2019/6/6 15:38
 */
